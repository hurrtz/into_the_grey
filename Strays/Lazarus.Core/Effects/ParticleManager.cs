...
namespace Lazarus.Core.Effects;
...
public class ParticleManager
{
    ...
    private void EmitConfetti(int numberOfParticles, Vector2 emitPosition, Color? color = null)
    {
        for (int i = 0; i < numberOfParticles; i++)
        {
            ...
            Color actualParticleColor =
                color ?? new Color(random.Next(256), random.Next(256), random.Next(256)); // Bright colors for confetti
    ...
    private void EmitSparkles(int numberOfParticles, Vector2 emitPosition, Color? color = null)
    {
        for (int i = 0; i < numberOfParticles; i++)
        {
            ...
            // Determine the particle's color
            Color actualParticleColor =
                color ?? Color.White * ((float)random.NextDouble() * 0.5f + 0.5f); // Light sparkly effect
