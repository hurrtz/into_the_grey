...
public class LocalizationManager
{
    ...
    private LocalizationManager()
    {
        ...
        _resourceManager = new ResourceManager("Strays.Core.Localization.Resources", assembly);
    ...
    public static List<CultureInfo> GetSupportedCultures()
    {
        ...
        Assembly assembly = Assembly.GetExecutingAssembly();
        ResourceManager resourceManager = new("Strays.Core.Localization.Resources", assembly);
