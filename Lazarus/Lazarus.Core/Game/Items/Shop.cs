...
public static class Shops
{
    ...
    private static void RegisterFringeShops()
    {
        ...
        Register(new ShopDefinition
        {
            ...
            OwnerName = "Patch",
            Greeting = "Need patching up? I've got what you need to keep your Kyns running.",
            Faction = FactionType.Independents,
            Biome = BiomeType.Fringe,
            BuysItems = true,
    ...
    private static void RegisterGreenShops()
    {
        Register(new ShopDefinition
        {
            ...
            Greeting = "May your Kyns find peace. How can I help?",
...
public static class Consumables
{
    ...
    static Consumables()
    {
        ...
        Register(new ConsumableDefinition
        {
            ...
            Description = "Restores 50 HP to one Kyn.",
            BasePrice = 50,
        ...
        Register(new ConsumableDefinition
        {
            ...
            Description = "Restores 150 HP to one Kyn.",
            BasePrice = 150,
        ...
        Register(new ConsumableDefinition
        {
            ...
            Description = "Restores 400 HP to one Kyn.",
            BasePrice = 400,
        ...
        Register(new ConsumableDefinition
        {
            ...
            Description = "Fully restores one Kyn's HP.",
            BasePrice = 800,
        ...
        Register(new ConsumableDefinition
        {
            Id = "energy_cell",
            Name = "Energy Cell",
            Description = "Restores 30 EP to one Kyn.",
            BasePrice = 75,
            Rarity = ItemRarity.Common,
        ...
        Register(new ConsumableDefinition
        {
            Id = "revival_core",
            Name = "Revival Core",
            Description = "Revives a defeated Kyn with 50% HP.",
            BasePrice = 500,
            Rarity = ItemRarity.Rare,
            Effect = ConsumableEffect.ReviveKyn,
            EffectPower = 50,
            UsableInCombat = true,
